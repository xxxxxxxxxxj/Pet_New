package com.haotang.deving.mvp.view.widget;
...
public class PermissionDialog {
    ...
    public PermissionDialog setContentView(View view) {
    ...
    public PermissionDialog setBackground(Drawable drawable) {
    ...
    public PermissionDialog setBackgroundResource(int resId) {
    ...
    public PermissionDialog setTitle(int resId) {
        mTitleResId = resId;
        if (mBuilder != null) {
    ...
    public PermissionDialog setTitle(CharSequence title) {
        mTitle = title;
        if (mBuilder != null) {
    ...
    public PermissionDialog setMessage(int resId) {
        mMessageResId = resId;
        if (mBuilder != null) {
    ...
    public PermissionDialog setMessage(CharSequence message) {
        mMessage = message;
        if (mBuilder != null) {
    ...
    public PermissionDialog setPositiveButton(int resId) {
        ...
        mPositiveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SystemTypeUtil.goToPermissionManager(mContext);
                dismiss();
            }
        });
        if (isLollipop()) {
    ...
    public PermissionDialog setPositiveButton(int resId, final View.OnClickListener listener) {
        mPositiveButton = new Button(mContext);
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.WRAP_CONTENT,
                LinearLayout.LayoutParams.WRAP_CONTENT
    ...
    public PermissionDialog setPositiveButton(String text, View.OnClickListener listener) {
        mPositiveButton = new Button(mContext);
        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.WRAP_CONTENT,
                LinearLayout.LayoutParams.WRAP_CONTENT
    ...
    public PermissionDialog setNegativeButton(int resId) {
    ...
    public PermissionDialog setNegativeButton(int resId, final View.OnClickListener listener) {
        mNegativeButton = new Button(mContext);
        mLayoutParams = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.WRAP_CONTENT,
                LinearLayout.LayoutParams.WRAP_CONTENT
    ...
    public PermissionDialog setNegativeButton(String text, final View.OnClickListener listener) {
        mNegativeButton = new Button(mContext);
        mLayoutParams = new LinearLayout.LayoutParams(
                LinearLayout.LayoutParams.WRAP_CONTENT,
                LinearLayout.LayoutParams.WRAP_CONTENT
    ...
    public PermissionDialog setCanceledOnTouchOutside(boolean cancel) {
        this.mCancel = cancel;
        if (mBuilder != null) {
    ...
    public PermissionDialog setCancelable(boolean cancelable) {
    ...
    public PermissionDialog setOnDismissListener(DialogInterface.OnDismissListener
                                                         onDismissListener) {
