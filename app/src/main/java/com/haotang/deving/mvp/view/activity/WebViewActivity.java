...
import com.haotang.deving.mvp.view.webview.MiddlewareChromeClient;
import com.haotang.deving.mvp.view.webview.MiddlewareWebViewClient;
import com.haotang.deving.mvp.view.webview.UIController;
...
//                .setNotifyIcon(R.drawable.ic_file_download_black_24dp) 4.0.0删除该api //下载通知图标。4.0.0后的版本请通过AgentWebDownloader#Extra修改icon
    ...
    protected PermissionInterceptor mPermissionInterceptor = new PermissionInterceptor() {
        ...
        public boolean intercept(String url, String[] permissions, String action) {
            RingLog.d(TAG, "mUrl:" + url + "  permission:" + mGson.toJson(permissions) + " action:" + action);
            return false;
        }
    };
    ...
    protected DownloadListenerAdapter mDownloadListenerAdapter = new DownloadListenerAdapter() {
        ...
        public void onBindService(String url, DownloadingService downloadingService) {
            ...
            RingLog.d(TAG, "onBindService:" + url + "  DownloadingService:" + downloadingService);
        }
        ...
        public void onUnbindService(String url, DownloadingService downloadingService) {
            ...
            RingLog.d(TAG, "onUnbindService:" + url);
        }
        ...
        public void onProgress(String url, long loaded, long length, long usedTime) {
            ...
            RingLog.d(TAG, "onProgress:" + mProgress);
    ...
    protected WebChromeClient mWebChromeClient = new WebChromeClient() {
        ...
        public void onProgressChanged(WebView view, int newProgress) {
            ...
            RingLog.d(TAG, "onProgressChanged:" + newProgress + "  view:" + view);
        }
    ...
    protected WebViewClient mWebViewClient = new WebViewClient() {
        ...
        public boolean shouldOverrideUrlLoading(final WebView view, String url) {
            RingLog.d(TAG, "view:" + new Gson().toJson(view.getHitTestResult()));
            RingLog.d(TAG, "mWebViewClient shouldOverrideUrlLoading:" + url);
        ...
        public void onPageStarted(WebView view, String url, Bitmap favicon) {
            RingLog.d(TAG, "mUrl:" + url + " onPageStarted  target:" + getUrl());
        ...
        public void onPageFinished(WebView view, String url) {
            ...
            if (timer.get(url) != null) {
                ...
                RingLog.d(TAG, "  page mUrl:" + url + "  used time:" + (overTime - startTime));
            }
        }
    ...
    private void openBrowser(String targetUrl) {
        if (TextUtils.isEmpty(targetUrl) || targetUrl.startsWith("file://")) {
            RingToast.show(targetUrl + " 该链接无法使用浏览器打开。");
            return;
        }
    ...
    private PopupMenu.OnMenuItemClickListener mOnMenuItemClickListener = new PopupMenu.OnMenuItemClickListener() {
        ...
        public boolean onMenuItemClick(MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.copy:
                    if (mAgentWeb != null) {
                        toCopy(WebViewActivity.this, mAgentWeb.getWebCreator().getWebView().getUrl());
                    }
                    return true;
