 ...
 *
 * @author 徐俊
 * @date XJ on 2018/4/27 15:26
 */
public class CommentTagAdapter extends BaseQuickAdapter<CommentTag, BaseViewHolder> {
    public CommentTagAdapter(int layoutResId, List<CommentTag> data) {
