 ...
 *
 * @author 徐俊
 * @date XJ on 2018/7/26 14:06
 */
public class ScreenCarModelAdapter  extends BaseQuickAdapter<ScreenCarCondition, BaseViewHolder> {
    public ScreenCarModelAdapter(int layoutResId, List<ScreenCarCondition> data) {
