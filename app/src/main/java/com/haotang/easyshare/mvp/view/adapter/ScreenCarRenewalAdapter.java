 ...
 *
 * @author 徐俊
 * @date XJ on 2018/7/26 14:07
 */
public class ScreenCarRenewalAdapter extends BaseQuickAdapter<ScreenCarCondition, BaseViewHolder> {
    public ScreenCarRenewalAdapter(int layoutResId, List<ScreenCarCondition> data) {
