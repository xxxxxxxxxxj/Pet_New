 ...
 */
public class SelectedCarAdapter extends BaseQuickAdapter<SelectedCarBean, BaseViewHolder> {
    public SelectedCarAdapter(int layoutResId, List<SelectedCarBean> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, SelectedCarBean item) {
