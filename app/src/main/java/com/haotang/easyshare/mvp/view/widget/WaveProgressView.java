...
public class WaveProgressView extends View {
    ...
    private void getAttrs(AttributeSet attrs) {
        ...
        mRadius = ta.getDimensionPixelSize(R.styleable.WaveProgressView_waveRadius, DEFAULT_RADIUS);
        mProgressHeight = mRadius * 2;
        mTextColor = ta.getColor(R.styleable.WaveProgressView_waveTextColor, Color.BLACK);
        mWaveColor = ta.getColor(R.styleable.WaveProgressView_waveWaveColor, Color.RED);
        ...
        mWaveHeight = ta.getDimensionPixelSize(R.styleable.WaveProgressView_waveWaveHeight, dp2px(DEFAULT_WAVE_HEIGHT));
