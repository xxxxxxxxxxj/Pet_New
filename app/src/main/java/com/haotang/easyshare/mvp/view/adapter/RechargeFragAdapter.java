 ...
 */
public class RechargeFragAdapter extends BaseQuickAdapter<RechargeFrag, BaseViewHolder> {
    public RechargeFragAdapter(int layoutResId, List<RechargeFrag> data) {
        super(layoutResId, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, final RechargeFrag item) {
