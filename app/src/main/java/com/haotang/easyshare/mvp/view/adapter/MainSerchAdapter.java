 ...
 *
 * @author 徐俊
 * @date zhoujunxia on 2018/9/9 17:11
 */
public class MainSerchAdapter  extends BaseQuickAdapter<SerchResult, BaseViewHolder> {
    public MainSerchAdapter(int layoutResId, List<SerchResult> data) {
