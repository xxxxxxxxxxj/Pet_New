 ...
 */
public class ScreenCarPriceAdapter extends BaseQuickAdapter<ScreenCarCondition, BaseViewHolder> {
    public ScreenCarPriceAdapter(int layoutResId, List<ScreenCarCondition> data) {
