 ...
 */
@ActivityScope
@Component(modules = LocalChargingActivityModule.class)
public interface LocalChargingActivityCommponent {
    void inject(LocalChargingActivity localChargingActivity);
}
