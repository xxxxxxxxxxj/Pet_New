...
public class ActivityListManager {
    ...
    public Activity getTopActivity() {
        if(this.mActivityList == null) {
            RingLog.w("mActivityList == null when getTopActivity()");
            return null;
        } else {
    ...
    public void removeActivity(Activity activity) {
        if(this.mActivityList == null) {
            RingLog.w("mActivityList == null when removeActivity(Activity)");
        } else {
            Class var2 = ActivityListManager.class;
            synchronized(ActivityListManager.class) {
    ...
    public Activity removeActivity(int location) {
        if(this.mActivityList == null) {
            RingLog.w("mActivityList == null when removeActivity(int)");
            return null;
        } else {
            Class var2 = ActivityListManager.class;
            synchronized(ActivityListManager.class) {
    ...
    public void killActivity(Class<?> activityClass) {
        if(this.mActivityList == null) {
            RingLog.w("mActivityList == null when killActivity(Class)");
        } else {
            Class var2 = ActivityListManager.class;
            synchronized(ActivityListManager.class) {
    ...
    public boolean activityInstanceIsLive(Activity activity) {
        if(this.mActivityList == null) {
            RingLog.w("mActivityList == null when activityInstanceIsLive(Activity)");
            return false;
        } else {
    ...
    public boolean activityClassIsLive(Class<?> activityClass) {
        if(this.mActivityList == null) {
            RingLog.w("mActivityList == null when activityClassIsLive(Class)");
            return false;
        } else {
    ...
    public Activity findActivity(Class<?> activityClass) {
        if(this.mActivityList == null) {
            RingLog.w("mActivityList == null when findActivity(Class)");
            return null;
        } else {
            Iterator var2 = this.mActivityList.iterator();
